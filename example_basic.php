...
<h2>Basic Example<annotation content="This is an annotation'."\n".'in the middle of the text" subject="My Subject" icon="Note" color="#FE88EF" author="Ian Back" /></h2>
<h3>Heading 3</h3>
<h4>Heading 4</h4>
<h5>Heading 5</h5>
<h6>Heading 6</h6>
...
define('_MPDF_PATH','/var/www/mpdf/');
include("/var/www/mpdf/mpdf.php");

$mpdf=new mPDF(); 

//$mpdf->SetProtection(array('copy', 'print', 'modify', 'annot-forms' ),''); 	// ensure to set annot-forms if encrypting

//$mpdf->SetUserRights(); 	// **** does NOT work as of Reader 9.0
